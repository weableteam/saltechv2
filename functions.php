...
function weable_scripts_loader() {
	...
	wp_enqueue_style( 'hai', get_template_directory_uri() . '/assets/css/team/hai.css', array(), $theme_version, 'all' );

	wp_enqueue_style( 'nhat', get_template_directory_uri() . '/assets/css/team/nhat.css', array(), $theme_version, 'all' );

	wp_enqueue_style( 'hoang', get_template_directory_uri() . '/assets/css/team/hoang.css', array(), $theme_version, 'all' );

	wp_enqueue_style( 'tin', get_template_directory_uri() . '/assets/css/team/tin.css', array(), $theme_version, 'all' );
...
function prefix_disable_gutenberg($current_status, $post_type)
{
    ...
    // Return current status for other post types
